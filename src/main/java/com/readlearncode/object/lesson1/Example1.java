...
public class Example1 {
    ...
    public JsonObject loadJsonObject() throws FileNotFoundException {
        ...
        JsonReader reader = Json.createReader(new FileReader("example1-jsondata-object.json"));
    ...
    public JsonArray loadJsonArray() throws FileNotFoundException {
        ...
        JsonReader reader = Json.createReader(new FileReader("example1-jsondata-array.json"));
